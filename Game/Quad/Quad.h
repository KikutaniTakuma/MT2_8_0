...
public:
	...
	Quad operator*(const class Matrix3x3& matrix);
...
public:
	...
	/// 位置を動かさずに上の辺変更(代入)
	/// </summary>
	/// <param name="num">動かしたい変更値</param>
	void ChangeSizeTop(float num);

	/// <summary>
	/// 位置を動かさずに下の辺変更(代入)
	/// </summary>
	/// <param name="num">動かしたい変更値</param>
	void ChangeSizeUnder(float num);

	/// <summary>
	/// 位置を動かさずに右の辺を変更(代入)
	/// </summary>
	/// <param name="num">動かしたい変更値</param>
	void ChangeSizeRight(float num);

	/// <summary>
	///  位置を動かさずに左の辺を変更(代入)
	/// </summary>
	/// <param name="num">動かしたい変更値</param>
	void ChangeSizeLeft(float num);
	...
	/// </summary>
	/// <param name="num">動かしたい変更値</param>
	void AddSizeTop(float num);

	/// <summary>
	/// 位置を動かさずに下の辺変更(加算)
	/// </summary>
	/// <param name="num">動かしたい変更値</param>
	void AddSizeUnder(float num);

	/// <summary>
	/// 位置を動かさずに右の辺を変更(加算)
	/// </summary>
	/// <param name="num">動かしたい変更値</param>
	void AddSizeRight(float num);

	/// <summary>
	///  位置を動かさずに左の辺を変更(加算)
	/// </summary>
	/// <param name="num">動かしたい変更値</param>
	void AddSizeLeft(float num);
};