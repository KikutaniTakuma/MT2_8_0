...
void Quad::ChangeSizeTop(float num) {
	leftTop.y = num;
	rightTop.y = num;
}

void Quad::ChangeSizeUnder(float num) {
	leftUnder.y = num;
	rightUnder.y = num;
}

void Quad::ChangeSizeRight(float num) {
	rightUnder.x = num;
	rightTop.x = num;
}

void Quad::ChangeSizeLeft(float num) {
	leftUnder.x = num;
	leftUnder.x = num;
}


void Quad::AddSizeTop(float num) {
	leftTop.y += num;
	rightTop.y += num;
}

void Quad::AddSizeUnder(float num) {
	leftUnder.y += num;
	rightUnder.y += num;
}

void Quad::AddSizeRight(float num) {
	rightUnder.x += num;
	rightTop.x += num;
}

void Quad::AddSizeLeft(float num) {
	leftUnder.x += num;
	leftUnder.x += num;
}